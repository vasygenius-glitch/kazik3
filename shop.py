...
ITEMS: dict[str, dict] = {
    ...
    # УЮТНАЯ ОСЕНЬ (СЕЗОН 5) - КОЛЛЕКЦИОННЫЕ ПРЕДМЕТЫ
    "autumn_scarf":    {"name": "🧣 Тёплый вязаный шарф", "price": 5_000, "cat": "cozy", "action": "other", "desc": "Мягкий шерстяной шарф, согревает в ненастье."},
    "autumn_sweater":  {"name": "🦌 Свитер с оленями", "price": 15_000, "cat": "cozy", "action": "other", "desc": "Уютный свитер с норвежскими узорами."},
    "autumn_thermos":  {"name": "☕ Термос с облепиховым чаем", "price": 8_000, "cat": "cozy", "action": "other", "desc": "Всегда горячий и ароматный чай."},
    "golden_leaf":     {"name": "🍁 Золотой кленовый лист", "price": 25_000, "cat": "cozy", "action": "other", "desc": "Редчайший осенний лист чистейшего золотого оттенка."},
    "pumpkin_pie":     {"name": "🥧 Домашний тыквенный пирог", "price": 10_000, "cat": "cozy", "action": "other", "desc": "Свежеиспечённый с корицей и мускатом."},
    "cozy_plaid":      {"name": "🛋️ Шерстяной клетчатый плед", "price": 50_000, "cat": "cozy", "action": "other", "desc": "Самый тёплый плед. Защищает от любой хандры."},
