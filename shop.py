...
ITEMS: dict[str, dict] = {
    ...
    # ДИКТОРЫ ТАЙНИЙ БАНИЙ (СЕЗОН 3) - 70 РАНГОВ РЕДКОСТИ
    ...
    "dictor_celestial":         {"name": "небесный диктор тайний баний", "price": 12_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Небесный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_astral":            {"name": "астральный диктор тайний баний", "price": 15_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Астральный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_quantum":           {"name": "квантовый диктор тайний баний", "price": 20_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Квантовый диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_singularity":       {"name": "сингулярный диктор тайний баний", "price": 25_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Сингулярный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_supernova":         {"name": "сверхновый диктор тайний баний", "price": 30_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Сверхновый диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_nebula":            {"name": "туманный диктор тайний баний", "price": 35_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Туманный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_hyperion":          {"name": "гиперионский диктор тайний баний", "price": 40_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Гиперионский диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_chronos":           {"name": "хронос-диктор тайний баний", "price": 50_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Хронос-диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_aether":            {"name": "эфирный диктор тайний баний", "price": 60_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Эфирный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_primordial":        {"name": "первозданный диктор тайний баний", "price": 75_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Первозданный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_supreme":           {"name": "верховный диктор тайний баний", "price": 90_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Верховный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_archon":            {"name": "архонтский диктор тайний баний", "price": 100_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Архонтский диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_seraph":            {"name": "серафимский диктор тайний баний", "price": 125_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Серафимский диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_leviathan":         {"name": "левиафанский диктор тайний баний", "price": 150_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Левиафанский диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_phoenix":           {"name": "феникс-диктор тайний баний", "price": 175_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Феникс-диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_titan":             {"name": "титанический диктор тайний баний", "price": 200_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Титанический диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_valkyrie":          {"name": "валькирийский диктор тайний баний", "price": 250_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Валькирийский диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_overlord":          {"name": "владыка-диктор тайний баний", "price": 300_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Владыка-диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_omega":             {"name": "омега-диктор тайний баний", "price": 350_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Омега-диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_alpha":             {"name": "альфа-диктор тайний баний", "price": 400_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Альфа-диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_multiverse":        {"name": "мультивселенский диктор тайний баний", "price": 500_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Мультивселенский диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_transcendent":      {"name": "трансцендентный диктор тайний баний", "price": 600_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Трансцендентный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_omnipotent":        {"name": "всемогущий диктор тайний баний", "price": 750_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Всемогущий диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_absolute":          {"name": "абсолютный диктор тайний баний", "price": 900_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Абсолютный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_infinity_plus":     {"name": "сверхбесконечный диктор тайний баний", "price": 1_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Сверхбесконечный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_dark_matter":       {"name": "тёмноматериальный диктор тайний баний", "price": 1_250_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Тёмноматериальный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_dark_energy":       {"name": "тёмноэнергетический диктор тайний баний", "price": 1_500_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Тёмноэнергетический диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_antimatter":        {"name": "антиматериальный диктор тайний баний", "price": 1_750_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Антиматериальный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_hyperdimensional":  {"name": "гиперпространственный диктор тайний баний", "price": 2_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Гиперпространственный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_zenith":             {"name": "зенитный диктор тайний баний", "price": 2_500_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Зенитный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_apex":               {"name": "апекс-диктор тайний баний", "price": 3_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Апекс-диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_genesis":            {"name": "генезис-диктор тайний баний", "price": 3_500_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Генезис-диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_apocalypse":         {"name": "апокалиптический диктор тайний баний", "price": 4_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Апокалиптический диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_ragnarok":           {"name": "рагнарёк-диктор тайний баний", "price": 5_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Рагнарёк-диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_valhalla":           {"name": "вальхалла-диктор тайний баний", "price": 6_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Вальхалла-диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_olympus":            {"name": "олимпский диктор тайний баний", "price": 7_500_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Олимпский диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_asgard":             {"name": "асгардский диктор тайний баний", "price": 9_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Асгардский диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_eldritch":           {"name": "иномировой диктор тайний баний", "price": 10_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Иномировой диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_cthulhu":            {"name": "ктулхический диктор тайний баний", "price": 12_500_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Ктулхический диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_solaris":            {"name": "солярис-диктор тайний баний", "price": 15_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Солярис-диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_lunar":              {"name": "лунный диктор тайний баний", "price": 17_500_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Лунный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_eclipse":            {"name": "затменный диктор тайний баний", "price": 20_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Затменный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_supernatural":       {"name": "сверхестественный диктор тайний баний", "price": 25_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Сверхестественный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_boundless":          {"name": "безграничный диктор тайний баний", "price": 30_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Безграничный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_eternity":           {"name": "вечность-диктор тайний баний", "price": 40_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Вечность-диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_creation":           {"name": "созидательный диктор тайний баний", "price": 50_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Созидательный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_destruction":        {"name": "разрушительный диктор тайний баний", "price": 60_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Разрушительный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_sovereign":          {"name": "суверенный диктор тайний баний", "price": 75_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Суверенный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_godlike":            {"name": "богоподобный диктор тайний баний", "price": 90_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Богоподобный диктор тайний баний (черный кролик 🖤🐇)."},
    "dictor_antigravity":        {"name": "антигравитационный диктор тайний баний", "price": 100_000_000_000, "cat": "tayniy_baniy", "action": "other", "desc": "Антигравитационный диктор тайний баний (черный кролик 🖤🐇)."},
}
