...
def test_500_simulated_bunker_games():
    """Симуляция 500 полных случайных партий игры «Бункер» от старта до финала."""
    active_games.clear()
