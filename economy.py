...
async def cmd_help(message: types.Message):
    text = (
        ...
        "• 🎁 <b>Бесплатный кейс (12ч):</b> <code>/бк</code> или <code>бесплатный кейс</code> — Забирай подарок раз в 12 часов!\n"
        "• 🎴 <b>Коллекция карточек свинок (200 шт):</b> <code>/cases</code>, <code>/inv</code>, <code>/collection</code>\n"
        "• 🧪 <b>Апгрейдер Дикторов:</b> <code>/banya_craft</code> — Крафти улучшенные версии дикторов (3 в 1, шанс 85%)!\n"
        "• 🗣 <b>TTS-Озвучка Дикторов:</b> <code>/banya_dictor</code> — Озвучка предсказания диктора голосовым сообщением!\n"
        "• 🛡 <b>Защита Дикторов:</b> Дикторы не сгорают при вайпах и сбросах экономики!\n"
        "• 📦 <b>Массовая продажа в /inv:</b> Выбор количества при продаже предметов (<code>1</code>, <code>5</code>, <code>10</code>, <code>50</code>, <code>Все</code>)!\n"
        "• 🤖 <b>ИИ-Противник (Версия 3):</b> Обыграй ИИ в <code>/rps</code>!\n"
        "• 🃏 <b>Умный Блэкджек:</b> <code>/bj</code> — Дилер подстраивается под твой стиль на основе прогнозов ИИ!\n"
        "• 📈 <b>Краш-Авиатор:</b> <code>/crash</code>\n"
        "• 🃏 <b>Видео-Покер:</b> <code>/poker</code>\n"
        "• 📈 <b>Фондовая Биржа:</b> <code>/stocks</code>\n"
        "• 📅 <b>Сезоны:</b> <code>/season</code> — Дикторы Тайний Баний!\n\n"
