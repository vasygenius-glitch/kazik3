...
CHANGELOG_TEXT = (
    "🚀 <b>ОБНОВЛЕНИЕ БОТА</b>\n"
    "━━━━━━━━━━━━━━━━━━━━━━\n\n"
    "☢️ <b>Новая игра «Бункер»:</b>\n"
    "• <code>/bunker</code> — Начать игру\n"
    "• <code>/bunker_stop</code> — Остановить игру\n\n"
    "💡 <b>Предложения и ошибки:</b>\n"
    "• <code>/предложение [текст]</code> — Написать разработчикам\n\n"
    "📢 <b>Информация:</b>\n"
    "• <code>/новости</code> — Последние обновления"
)
